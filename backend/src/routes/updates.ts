...
다음 기준으로 각 글을 판별하세요:
- KEEP: 서든어택 게임 관련 유의미한 정보 (업데이트, 패치, 버그, 밸런스, 이벤트, 대회, 메타, 공략, 진지한 의견/토론)
- SKIP (반드시 제거):
  * 디스코드/디코/오픈채팅/카톡 홍보 및 개인거래/SP거래/밀봉거래/현금거래 관련 글
  * 욕설, 비속어, 성적 표현, 혐오 표현이 포함된 글 (ㅅㅂ, ㅆㅂ, 씹, 좆, 병신, 찐따, 쓰레기 등 변형 포함)
  * 낚시글, 도배, 광고, 유튜브/스트리머 홍보
  * 게임과 완전히 무관한 개인 잡담, 일상, 정치, 연예
  * 특정 유저 저격/비방 글
